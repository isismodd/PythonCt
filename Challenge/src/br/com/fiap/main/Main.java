...
public class Main {
    public static void main(String[] args) {
        ...
        // Criando médicos
        Medico cirurgiao = new Medico("Dr. Silva", "CRM/SP 12345", AreaAtuacao.CIRURGIAO);
        Medico cardiologista = new Medico("Dra. Oliveira", "CRM/SP 54321", AreaAtuacao.CARDIOLOGIA);

        unidade1.adicionarMedico(cirurgiao);
        unidade2.adicionarMedico(cardiologista);
        ...
        System.out.println("Médico: " + consulta1.getMedico().getNome() +
                " (" + consulta1.getMedico().getEspecialidade() + ")");
